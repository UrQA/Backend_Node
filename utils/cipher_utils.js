...
//  암호화
exports.encrypt_wallaby = function(str, key) {
  try {
...
// 복호화
exports.decrypt_wallaby = function(str, key) {
  try {
    ...
    var ret = new Buffer(result, 'binary');
    console.log('res2: ' + ret.toString('utf8'));
...
var HASH_UPDATE_DATA  = 'GumiKoreaNumberONE!!!';
